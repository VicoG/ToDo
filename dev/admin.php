      ...
      <section id="content" class="table-layout animated fadeIn">
		 <div class="tray tray-center">
			...
			<?php //$layout_context = "admin"; ?>
			 ...
			 <div class="row">                                        	
                <div class="col-md-6 col-md-offset-4 mt40 pt40"> 
				<h1>Administration Menu</h1>
					<h3><a href="index.php"><span class="glyphicon glyphicon-home"></span><span class="sidebar-title">  Home/ Dashboard</span></a></h3>
					<h3><a href="manage_admins.php">Manage Admin/ Users</a></h3>
					<h3><a href="utr-logout.php">Logout</a></h3>
			  </div>
		  </div>
		</div>      
      </section>
