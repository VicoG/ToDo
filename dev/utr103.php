	...
	<li class="sidebar-label">
	  <div class="panel panel-tile text-primary br-b bw5 br-primary-light mt40">
            <div class="panel-body pl20 p5">                 
			 <img src="assets/images/action.png" alr="A" class="img-responsive pull-right" />
			<h2 class="mt15 lh15">
				<b>103</b>
			</h2>
		...
		<div class="panel-footer bg-white br-t br-light p12">
			<a href="l2.php?id=100&subid=104" class="btn btn-primary pull-right mb15 mt15">Next (Stand Down?)</a>                                                
		</div>                          
	  </div>         
    </li>
	<li class="sidebar-label">                                
...
<div class="panel-body  p20" id="invoice-item">            
	<div class="row col-md-12 mt10 pt10">
		<h2>Alert/ consider standing up additional resources (e.g. JIC).</h2>
		 <a href="l2.php?id=200&subid=200" class="btn btn-primary pull-right mb15 mt15">Next</a>
	</div>
</div>
