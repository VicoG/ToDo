	...
	<li class="sidebar-label">
	  <div class="panel panel-tile text-primary br-b bw5 br-primary-light mt40">
            <div class="panel-body pl20 p5">               
			 <img src="assets/images/round_rec.png" alt="RR" class="img-responsive pull-right" />
			<h2 class="mt15 lh15">
				<b>101</b>
			</h2>
...
<div class="panel-body  p20" id="invoice-item">            
	<div class="row col-md-12 mt10 pt10">
		<h2>Suspect release site(s) identified.</h2>
		 <a href="l2.php?id=100&subid=102" class="btn btn-primary pull-right mb15 mt15">Next</a> 
	</div>
</div>
